...
Test(Carrier, test_Carrier_bitwise_operator_overloading, .init = redirect_all_stdout)
{
    {    
        Carrier c("HellExpress");
...
Test(Carrier, test_Carrier_parenthesis_operator_overloading, .init = redirect_all_stdout)
{
    {    
        Carrier c("HellExpress");
        ...
        c.setEnergy(0);
        cr_assert(c.getEnergy() == 0);
        cr_assert(c(5, 8) == false);
    }
    cr_assert_stdout_eq_str(
    "Droid 'Commander' Activated\n"
    "Droid 'Sergent' Activated\n"
...
Test(Carrier, test_Carrier_left_stream_operator_overloading_print_format, .init = redirect_all_stdout)
{
    {    
        Carrier c("HellExpress");
...
Test(Carrier, test_Carrier_left_steram_operator_overloading_reload_energy, .init = redirect_all_stdout)
{
    {    
        Carrier c("HellExpress");
        ...
        std::cout << c << std::endl;
        c[3] = 0;
        cr_assert(zero(type(Droid *), c[3]));
        c[4] = 0;
        cr_assert(zero(type(Droid *), c[4]));
        (~c)(-15, 4);
        std::cout << c << std::endl;

        size_t reload = 600;
        c << reload;
        cr_assert(c.getEnergy() == 600);
    }
    cr_assert_stdout_eq_str(
    "Droid 'Commander' Activated\n"
    "Droid 'Sergent' Activated\n"
...
Test(Carrier, test_Carrier_main_function, .init = redirect_all_stdout)
{
    {    
        Carrier c("HellExpress");
...
Test(Supply, test_size_t, .init = redirect_all_stdout)
{
    {
        Droid **w = new Droid*[10];
        char c = '0';
...
Test(Supply, test_pointer, .init = redirect_all_stdout)
{
    {
        Droid **w = new Droid*[10];
        char c = '0';
...
Test(Supply, test_prefix_PlusPlus_operator_overloading, .init = redirect_all_stdout)
{
    {
        Droid **w = new Droid*[10];
        char c = '0';
...
{
    {
        ...
        *s3 = 0;
        ...
        std::cout << !s3 << std::endl;
        for (int i = 0; i < 3; i++)
            cr_assert(zero(type(Droid *), s3.getWreck(i)));
        cr_assert(zero(type(Droid *), s3.getWreck()));
        cr_assert(s3.getAmount() == 0);
        cr_assert(s3 == Supply::Wreck);
        cr_assert(s3 != Supply::Iron);
...
Test(DroidFactory, test_DroidFactory_class_construction, .init = redirect_all_stdout)
{
    {
...
Test(DroidFactory,
    test_DroidFactory_right_stream_operator_overloading_construction_Droid,
...
{
    {
        ...
        cr_assert(factory.getSilicon() == 0);
        factory.setSilicon(100);
        cr_assert(factory.getSilicon() == 100);
...
Test(DroidFactory,
    test_DroidFactory_left_stream_operator_overloading_display_status,
    .init = redirect_all_stdout)
{
    {
        DroidFactory factory(3);
...
Test(DroidFactory,
    test_DroidFactory_left_stream_operator_overloading_load_Supply,
.init = redirect_all_stdout)
{
    {
        DroidFactory factory(3);
